    ...
    <div className="bg-black min-h-screen flex flex-col gap-2 items-center p-6">
      ...
      >
        ...
        <div className="border-b border-zinc-400 pb-4">
          <h1 className="text-4xl font-bold text-gray-800">{name || 'Anurag Singh'}</h1>
          <p className="text-lg text-gray-600">{title || 'Senior Software Engineer'}</p>
          <p className="text-sm text-gray-500 mt-2">
            <span>{contact.email || 'anurag@gmail.com'}</span> | <span>{contact.phone || '(123) 456-7890 '}</span> | <span>{contact.website || 'https://www.linkedin.com/in/anurag-singh-200001315/'}</span>
          </p>
        </div>
