      ...
      <div  ref={resumeRef}
        ...
        <header className="border-b border-zinc-400 pb-4 mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-800">{name || 'Anurag Singh'}</h1>
              <p className="text-gray-600">{title || 'Senior Software Engineer'}</p>
            </div>
            <div className="text-right">
              <p className="text-gray-600">{contact.email || 'anurag@gmail.com'}</p>
              <p className="text-gray-600">{contact.phone || '(123) 456-7890 '}</p>
              <p className="text-gray-600">{contact.website || 'https://www.linkedin.com/in/anurag-singh-200001315/'}</p>
            </div>
          </div>
        </header>
