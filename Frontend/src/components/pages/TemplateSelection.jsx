    ...
    return (
        <div className='h-screen w-screen bg-[#0a0a0a] text-white'>
            ...
            <div className='w-full pt-10 flex gap-[3vw] px-5 cursor'>
                ...
                />
                <img
                    className={`w-[25%] ${selectedImage === 3 ? 'border-blue-500 border-[3px]' : ''}`}
                    src="/images/resume-1_page-0001.jpg"
                    alt="img"
                    onClick={() => handleImageClick(3)}
                />
                <img
                    className={`w-[25%] ${selectedImage === 4 ? 'border-blue-500 border-[3px]' : ''}`}
                    src="/images/resume-4_page-0001.jpg"
                    alt="img"
